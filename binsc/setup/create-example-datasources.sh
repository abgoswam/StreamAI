...
kafka-topics.sh --zookeeper localhost:2181 --delete --topic teststreamai2
kafka-topics.sh --zookeeper localhost:2181 --create --topic teststreamai2 --partitions 1 --replication-factor 1
